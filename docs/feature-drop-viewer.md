...
- A sidebar lists every loaded model and provides per-model toggles for visibility and wireframe view. Toggling updates the scene immediately so contributors can compare meshes without reloading.
