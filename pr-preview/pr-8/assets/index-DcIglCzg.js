...
`)+`
`+M);const y=x+p+a,C=x+M+o,b=$o(i,i.VERTEX_SHADER,y),E=$o(i,i.FRAGMENT_SHADER,C);i.attachShader(f,b),i.attachShader(f,E),t.index0AttributeName!==void 0?i.bindAttribLocation(f,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(f,0,"position"),i.linkProgram(f);function B(W){if(s.debug.checkShaderErrors){const Z=i.getProgramInfoLog(f).trim(),I=i.getShaderInfoLog(b).trim(),V=i.getShaderInfoLog(E).trim();let U=!0,Y=!0;if(i.getProgramParameter(f,i.LINK_STATUS)===!1)if(U=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,f,b,E);else{const X=Zo(i,b,"vertex"),q=Zo(i,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(f,i.VALIDATE_STATUS)+`
...
}`;function ig(s,e,t){let n=new xa;const i=new we,r=new we,a=new tt,o=new Qm({depthPacking:Fu}),c=new eg,l={},u=t.maxTextureSize,h={[mn]:Dt,[Dt]:mn,[Yt]:Yt},d=new Nn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new we},radius:{value:4}},vertexShader:tg,fragmentShader:ng}),m=d.clone();m.defines.HORIZONTAL_PASS=1;const g=new Et;g.setAttribute("position",new vt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new _t(g,d),f=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Kc;let p=this.type;this.render=function(b,E,B){if(f.enabled===!1||f.autoUpdate===!1&&f.needsUpdate===!1||b.length===0)return;const j=s.getRenderTarget(),v=s.getActiveCubeFace(),w=s.getActiveMipmapLevel(),W=s.state;W.setBlending(Pn),W.buffers.color.setClear(1,1,1,1),W.buffers.depth.setTest(!0),W.setScissorTest(!1);const Z=p!==dn&&this.type===dn,I=p===dn&&this.type!==dn;for(let V=0,U=b.length;V<U;V++){const Y=b[V],X=Y.shadow;if(X===void 0){console.warn("THREE.WebGLShadowMap:",Y,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;i.copy(X.mapSize);const q=X.getFrameExtents();if(i.multiply(q),r.copy(X.mapSize),(i.x>u||i.y>u)&&(i.x>u&&(r.x=Math.floor(u/q.x),i.x=r.x*q.x,X.mapSize.x=r.x),i.y>u&&(r.y=Math.floor(u/q.y),i.y=r.y*q.y,X.mapSize.y=r.y)),X.map===null||Z===!0||I===!0){const ne=this.type!==dn?{minFilter:gt,magFilter:gt}:{};X.map!==null&&X.map.dispose(),X.map=new Zn(i.x,i.y,ne),X.map.texture.name=Y.name+".shadowMap",X.camera.updateProjectionMatrix()}s.setRenderTarget(X.map),s.clear();const $=X.getViewportCount();for(let ne=0;ne<$;ne++){const ce=X.getViewport(ne);a.set(r.x*ce.x,r.y*ce.y,r.x*ce.z,r.y*ce.w),W.viewport(a),X.updateMatrices(Y,ne),n=X.getFrustum(),y(E,B,X.camera,Y,this.type)}X.isPointLightShadow!==!0&&this.type===dn&&M(X,B),X.needsUpdate=!1}p=this.type,f.needsUpdate=!1,s.setRenderTarget(j,v,w)};function M(b,E){const B=e.update(_);d.defines.VSM_SAMPLES!==b.blurSamples&&(d.defines.VSM_SAMPLES=b.blurSamples,m.defines.VSM_SAMPLES=b.blurSamples,d.needsUpdate=!0,m.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new Zn(i.x,i.y)),d.uniforms.shadow_pass.value=b.map.texture,d.uniforms.resolution.value=b.mapSize,d.uniforms.radius.value=b.radius,s.setRenderTarget(b.mapPass),s.clear(),s.renderBufferDirect(E,null,B,d,_,null),m.uniforms.shadow_pass.value=b.mapPass.texture,m.uniforms.resolution.value=b.mapSize,m.uniforms.radius.value=b.radius,s.setRenderTarget(b.map),s.clear(),s.renderBufferDirect(E,null,B,m,_,null)}function x(b,E,B,j){let v=null;const w=B.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(w!==void 0)v=w;else if(v=B.isPointLight===!0?c:o,s.localClippingEnabled&&E.clipShadows===!0&&Array.isArray(E.clippingPlanes)&&E.clippingPlanes.length!==0||E.displacementMap&&E.displacementScale!==0||E.alphaMap&&E.alphaTest>0||E.map&&E.alphaTest>0){const W=v.uuid,Z=E.uuid;let I=l[W];I===void 0&&(I={},l[W]=I);let V=I[Z];V===void 0&&(V=v.clone(),I[Z]=V,E.addEventListener("dispose",C)),v=V}if(v.visible=E.visible,v.wireframe=E.wireframe,j===dn?v.side=E.shadowSide!==null?E.shadowSide:E.side:v.side=E.shadowSide!==null?E.shadowSide:h[E.side],v.alphaMap=E.alphaMap,v.alphaTest=E.alphaTest,v.map=E.map,v.clipShadows=E.clipShadows,v.clippingPlanes=E.clippingPlanes,v.clipIntersection=E.clipIntersection,v.displacementMap=E.displacementMap,v.displacementScale=E.displacementScale,v.displacementBias=E.displacementBias,v.wireframeLinewidth=E.wireframeLinewidth,v.linewidth=E.linewidth,B.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const W=s.properties.get(v);W.light=B}return v}function y(b,E,B,j,v){if(b.visible===!1)return;if(b.layers.test(E.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&v===dn)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(B.matrixWorldInverse,b.matrixWorld);const Z=e.update(b),I=b.material;if(Array.isArray(I)){const V=Z.groups;for(let U=0,Y=V.length;U<Y;U++){const X=V[U],q=I[X.materialIndex];if(q&&q.visible){const $=x(b,q,j,v);b.onBeforeShadow(s,b,E,B,Z,$,X),s.renderBufferDirect(B,null,Z,$,b,X),b.onAfterShadow(s,b,E,B,Z,$,X)}}}else if(I.visible){const V=x(b,I,j,v);b.onBeforeShadow(s,b,E,B,Z,V,null),s.renderBufferDirect(B,null,Z,V,b,null),b.onAfterShadow(s,b,E,B,Z,V,null)}}const W=b.children;for(let Z=0,I=W.length;Z<I;Z++)y(W[Z],E,B,j,v)}function C(b){b.target.removeEventListener("dispose",C);for(const B in l){const j=l[B],v=b.target.uuid;v in j&&(j[v].dispose(),delete j[v])}}}function sg(s,e,t){const n=t.isWebGL2;function i(){let R=!1;const se=new tt;let te=null;const xe=new tt(0,0,0,0);return{setMask:function(be){te!==be&&!R&&(s.colorMask(be,be,be,be),te=be)},setLocked:function(be){R=be},setClear:function(be,Ye,Xe,et,yt){yt===!0&&(be*=et,Ye*=et,Xe*=et),se.set(be,Ye,Xe,et),xe.equals(se)===!1&&(s.clearColor(be,Ye,Xe,et),xe.copy(se))},reset:function(){R=!1,te=null,xe.set(-1,0,0,0)}}}function r(){let R=!1,se=null,te=null,xe=null;return{setTest:function(be){be?ge(s.DEPTH_TEST):ze(s.DEPTH_TEST)},setMask:function(be){se!==be&&!R&&(s.depthMask(be),se=be)},setFunc:function(be){if(te!==be){switch(be){case hu:s.depthFunc(s.NEVER);break;case du:s.depthFunc(s.ALWAYS);break;case fu:s.depthFunc(s.LESS);break;case Gs:s.depthFunc(s.LEQUAL);break;case pu:s.depthFunc(s.EQUAL);break;case mu:s.depthFunc(s.GEQUAL);break;case gu:s.depthFunc(s.GREATER);break;case _u:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}te=be}},setLocked:function(be){R=be},setClear:function(be){xe!==be&&(s.clearDepth(be),xe=be)},reset:function(){R=!1,se=null,te=null,xe=null}}}function a(){let R=!1,se=null,te=null,xe=null,be=null,Ye=null,Xe=null,et=null,yt=null;return{setTest:function(Ke){R||(Ke?ge(s.STENCIL_TEST):ze(s.STENCIL_TEST))},setMask:function(Ke){se!==Ke&&!R&&(s.stencilMask(Ke),se=Ke)},setFunc:function(Ke,lt,Rt){(te!==Ke||xe!==lt||be!==Rt)&&(s.stencilFunc(Ke,lt,Rt),te=Ke,xe=lt,be=Rt)},setOp:function(Ke,lt,Rt){(Ye!==Ke||Xe!==lt||et!==Rt)&&(s.stencilOp(Ke,lt,Rt),Ye=Ke,Xe=lt,et=Rt)},setLocked:function(Ke){R=Ke},setClear:function(Ke){yt!==Ke&&(s.clearStencil(Ke),yt=Ke)},reset:function(){R=!1,se=null,te=null,xe=null,be=null,Ye=null,Xe=null,et=null,yt=null}}}const o=new i,c=new r,l=new a,u=new WeakMap,h=new WeakMap;let d={},m={},g=new WeakMap,_=[],f=null,p=!1,M=null,x=null,y=null,C=null,b=null,E=null,B=null,j=new Re(0,0,0),v=0,w=!1,W=null,Z=null,I=null,V=null,U=null;const Y=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,q=0;const $=s.getParameter(s.VERSION);$.indexOf("WebGL")!==-1?(q=parseFloat(/^WebGL (\d)/.exec($)[1]),X=q>=1):$.indexOf("OpenGL ES")!==-1&&(q=parseFloat(/^OpenGL ES (\d)/.exec($)[1]),X=q>=2);let ne=null,ce={};const Te=s.getParameter(s.SCISSOR_BOX),k=s.getParameter(s.VIEWPORT),K=new tt().fromArray(Te),fe=new tt().fromArray(k);function ve(R,se,te,xe){const be=new Uint8Array(4),Ye=s.createTexture();s.bindTexture(R,Ye),s.texParameteri(R,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(R,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let Xe=0;Xe<te;Xe++)n&&(R===s.TEXTURE_3D||R===s.TEXTURE_2D_ARRAY)?s.texImage3D(se,0,s.RGBA,1,1,xe,0,s.RGBA,s.UNSIGNED_BYTE,be):s.texImage2D(se+Xe,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,be);return Ye}const Me={};Me[s.TEXTURE_2D]=ve(s.TEXTURE_2D,s.TEXTURE_2D,1),Me[s.TEXTURE_CUBE_MAP]=ve(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),n&&(Me[s.TEXTURE_2D_ARRAY]=ve(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),Me[s.TEXTURE_3D]=ve(s.TEXTURE_3D,s.TEXTURE_3D,1,1)),o.setClear(0,0,0,1),c.setClear(1),l.setClear(0),ge(s.DEPTH_TEST),c.setFunc(Gs),Pe(!1),A(Na),ge(s.CULL_FACE),oe(Pn);function ge(R){d[R]!==!0&&(s.enable(R),d[R]=!0)}function ze(R){d[R]!==!1&&(s.disable(R),d[R]=!1)}function Le(R,se){return m[R]!==se?(s.bindFramebuffer(R,se),m[R]=se,n&&(R===s.DRAW_FRAMEBUFFER&&(m[s.FRAMEBUFFER]=se),R===s.FRAMEBUFFER&&(m[s.DRAW_FRAMEBUFFER]=se)),!0):!1}function D(R,se){let te=_,xe=!1;if(R)if(te=g.get(se),te===void 0&&(te=[],g.set(se,te)),R.isWebGLMultipleRenderTargets){const be=R.texture;if(te.length!==be.length||te[0]!==s.COLOR_ATTACHMENT0){for(let Ye=0,Xe=be.length;Ye<Xe;Ye++)te[Ye]=s.COLOR_ATTACHMENT0+Ye;te.length=be.length,xe=!0}}else te[0]!==s.COLOR_ATTACHMENT0&&(te[0]=s.COLOR_ATTACHMENT0,xe=!0);else te[0]!==s.BACK&&(te[0]=s.BACK,xe=!0);xe&&(t.isWebGL2?s.drawBuffers(te):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(te))}function ot(R){return f!==R?(s.useProgram(R),f=R,!0):!1}const H={[Xn]:s.FUNC_ADD,[$l]:s.FUNC_SUBTRACT,[Zl]:s.FUNC_REVERSE_SUBTRACT};if(n)H[Ba]=s.MIN,H[za]=s.MAX;else{const R=e.get("EXT_blend_minmax");R!==null&&(H[Ba]=R.MIN_EXT,H[za]=R.MAX_EXT)}const J={[Jl]:s.ZERO,[Ql]:s.ONE,[eu]:s.SRC_COLOR,[Kr]:s.SRC_ALPHA,[au]:s.SRC_ALPHA_SATURATE,[su]:s.DST_COLOR,[nu]:s.DST_ALPHA,[tu]:s.ONE_MINUS_SRC_COLOR,[$r]:s.ONE_MINUS_SRC_ALPHA,[ru]:s.ONE_MINUS_DST_COLOR,[iu]:s.ONE_MINUS_DST_ALPHA,[ou]:s.CONSTANT_COLOR,[cu]:s.ONE_MINUS_CONSTANT_COLOR,[lu]:s.CONSTANT_ALPHA,[uu]:s.ONE_MINUS_CONSTANT_ALPHA};function oe(R,se,te,xe,be,Ye,Xe,et,yt,Ke){if(R===Pn){p===!0&&(ze(s.BLEND),p=!1);return}if(p===!1&&(ge(s.BLEND),p=!0),R!==Kl){if(R!==M||Ke!==w){if((x!==Xn||b!==Xn)&&(s.blendEquation(s.FUNC_ADD),x=Xn,b=Xn),Ke)switch(R){case Ei:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Ua:s.blendFunc(s.ONE,s.ONE);break;case Oa:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Fa:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}else switch(R){case Ei:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Ua:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case Oa:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Fa:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}y=null,C=null,E=null,B=null,j.set(0,0,0),v=0,M=R,w=Ke}return}be=be||se,Ye=Ye||te,Xe=Xe||xe,(se!==x||be!==b)&&(s.blendEquationSeparate(H[se],H[be]),x=se,b=be),(te!==y||xe!==C||Ye!==E||Xe!==B)&&(s.blendFuncSeparate(J[te],J[xe],J[Ye],J[Xe]),y=te,C=xe,E=Ye,B=Xe),(et.equals(j)===!1||yt!==v)&&(s.blendColor(et.r,et.g,et.b,yt),j.copy(et),v=yt),M=R,w=!1}function qe(R,se){R.side===Yt?ze(s.CULL_FACE):ge(s.CULL_FACE);let te=R.side===Dt;se&&(te=!te),Pe(te),R.blending===Ei&&R.transparent===!1?oe(Pn):oe(R.blending,R.blendEquation,R.blendSrc,R.blendDst,R.blendEquationAlpha,R.blendSrcAlpha,R.blendDstAlpha,R.blendColor,R.blendAlpha,R.premultipliedAlpha),c.setFunc(R.depthFunc),c.setTest(R.depthTest),c.setMask(R.depthWrite),o.setMask(R.colorWrite);const xe=R.stencilWrite;l.setTest(xe),xe&&(l.setMask(R.stencilWriteMask),l.setFunc(R.stencilFunc,R.stencilRef,R.stencilFuncMask),l.setOp(R.stencilFail,R.stencilZFail,R.stencilZPass)),O(R.polygonOffset,R.polygonOffsetFactor,R.polygonOffsetUnits),R.alphaToCoverage===!0?ge(s.SAMPLE_ALPHA_TO_COVERAGE):ze(s.SAMPLE_ALPHA_TO_COVERAGE)}function Pe(R){W!==R&&(R?s.frontFace(s.CW):s.frontFace(s.CCW),W=R)}function A(R){R!==jl?(ge(s.CULL_FACE),R!==Z&&(R===Na?s.cullFace(s.BACK):R===ql?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):ze(s.CULL_FACE),Z=R}function S(R){R!==I&&(X&&s.lineWidth(R),I=R)}function O(R,se,te){R?(ge(s.POLYGON_OFFSET_FILL),(V!==se||U!==te)&&(s.polygonOffset(se,te),V=se,U=te)):ze(s.POLYGON_OFFSET_FILL)}function re(R){R?ge(s.SCISSOR_TEST):ze(s.SCISSOR_TEST)}function Q(R){R===void 0&&(R=s.TEXTURE0+Y-1),ne!==R&&(s.activeTexture(R),ne=R)}function ie(R,se,te){te===void 0&&(ne===null?te=s.TEXTURE0+Y-1:te=ne);let xe=ce[te];xe===void 0&&(xe={type:void 0,texture:void 0},ce[te]=xe),(xe.type!==R||xe.texture!==se)&&(ne!==te&&(s.activeTexture(te),ne=te),s.bindTexture(R,se||Me[R]),xe.type=R,xe.texture=se)}function _e(){const R=ce[ne];R!==void 0&&R.type!==void 0&&(s.bindTexture(R.type,null),R.type=void 0,R.texture=void 0)}function ue(){try{s.compressedTexImage2D.apply(s,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function me(){try{s.compressedTexImage3D.apply(s,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Ae(){try{s.texSubImage2D.apply(s,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Ne(){try{s.texSubImage3D.apply(s,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function ee(){try{s.compressedTexSubImage2D.apply(s,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function $e(){try{s.compressedTexSubImage3D.apply(s,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function He(){try{s.texStorage2D.apply(s,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Ie(){try{s.texStorage3D.apply(s,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Se(){try{s.texImage2D.apply(s,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function de(){try{s.texImage3D.apply(s,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Oe(R){K.equals(R)===!1&&(s.scissor(R.x,R.y,R.z,R.w),K.copy(R))}function L(R){fe.equals(R)===!1&&(s.viewport(R.x,R.y,R.z,R.w),fe.copy(R))}function ae(R,se){let te=h.get(se);te===void 0&&(te=new WeakMap,h.set(se,te));let xe=te.get(R);xe===void 0&&(xe=s.getUniformBlockIndex(se,R.name),te.set(R,xe))}function he(R,se){const xe=h.get(se).get(R);u.get(se)!==xe&&(s.uniformBlockBinding(se,xe,R.__bindingPointIndex),u.set(se,xe))}function Ee(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),n===!0&&(s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null)),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),d={},ne=null,ce={},m={},g=new WeakMap,_=[],f=null,p=!1,M=null,x=null,y=null,C=null,b=null,E=null,B=null,j=new Re(0,0,0),v=0,w=!1,W=null,Z=null,I=null,V=null,U=null,K.set(0,0,s.canvas.width,s.canvas.height),fe.set(0,0,s.canvas.width,s.canvas.height),o.reset(),c.reset(),l.reset()}return{buffers:{color:o,depth:c,stencil:l},enable:ge,disable:ze,bindFramebuffer:Le,drawBuffers:D,useProgram:ot,setBlending:oe,setMaterial:qe,setFlipSided:Pe,setCullFace:A,setLineWidth:S,setPolygonOffset:O,setScissorTest:re,activeTexture:Q,bindTexture:ie,unbindTexture:_e,compressedTexImage2D:ue,compressedTexImage3D:me,texImage2D:Se,texImage3D:de,updateUBOMapping:ae,uniformBlockBinding:he,texStorage2D:He,texStorage3D:Ie,texSubImage2D:Ae,texSubImage3D:Ne,compressedTexSubImage2D:ee,compressedTexSubImage3D:$e,scissor:Oe,viewport:L,reset:Ee}}function rg(s,e,t,n,i,r,a){const o=i.isWebGL2,c=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new WeakMap;let h;const d=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,S){return m?new OffscreenCanvas(A,S):ns("canvas")}function _(A,S,O,re){let Q=1;if((A.width>re||A.height>re)&&(Q=re/Math.max(A.width,A.height)),Q<1||S===!0)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap){const ie=S?qs:Math.floor,_e=ie(Q*A.width),ue=ie(Q*A.height);h===void 0&&(h=g(_e,ue));const me=O?g(_e,ue):h;return me.width=_e,me.height=ue,me.getContext("2d").drawImage(A,0,0,_e,ue),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+A.width+"x"+A.height+") to ("+_e+"x"+ue+")."),me}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+A.width+"x"+A.height+")."),A;return A}function f(A){return ia(A.width)&&ia(A.height)}function p(A){return o?!1:A.wrapS!==Vt||A.wrapT!==Vt||A.minFilter!==gt&&A.minFilter!==wt}function M(A,S){return A.generateMipmaps&&S&&A.minFilter!==gt&&A.minFilter!==wt}function x(A){s.generateMipmap(A)}function y(A,S,O,re,Q=!1){if(o===!1)return S;if(A!==null){if(s[A]!==void 0)return s[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let ie=S;if(S===s.RED&&(O===s.FLOAT&&(ie=s.R32F),O===s.HALF_FLOAT&&(ie=s.R16F),O===s.UNSIGNED_BYTE&&(ie=s.R8)),S===s.RED_INTEGER&&(O===s.UNSIGNED_BYTE&&(ie=s.R8UI),O===s.UNSIGNED_SHORT&&(ie=s.R16UI),O===s.UNSIGNED_INT&&(ie=s.R32UI),O===s.BYTE&&(ie=s.R8I),O===s.SHORT&&(ie=s.R16I),O===s.INT&&(ie=s.R32I)),S===s.RG&&(O===s.FLOAT&&(ie=s.RG32F),O===s.HALF_FLOAT&&(ie=s.RG16F),O===s.UNSIGNED_BYTE&&(ie=s.RG8)),S===s.RGBA){const _e=Q?ks:Ze.getTransfer(re);O===s.FLOAT&&(ie=s.RGBA32F),O===s.HALF_FLOAT&&(ie=s.RGBA16F),O===s.UNSIGNED_BYTE&&(ie=_e===it?s.SRGB8_ALPHA8:s.RGBA8),O===s.UNSIGNED_SHORT_4_4_4_4&&(ie=s.RGBA4),O===s.UNSIGNED_SHORT_5_5_5_1&&(ie=s.RGB5_A1)}return(ie===s.R16F||ie===s.R32F||ie===s.RG16F||ie===s.RG32F||ie===s.RGBA16F||ie===s.RGBA32F)&&e.get("EXT_color_buffer_float"),ie}function C(A,S,O){return M(A,O)===!0||A.isFramebufferTexture&&A.minFilter!==gt&&A.minFilter!==wt?Math.log2(Math.max(S.width,S.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?S.mipmaps.length:1}function b(A){return A===gt||A===Qr||A===vi?s.NEAREST:s.LINEAR}function E(A){const S=A.target;S.removeEventListener("dispose",E),j(S),S.isVideoTexture&&u.delete(S)}function B(A){const S=A.target;S.removeEventListener("dispose",B),w(S)}function j(A){const S=n.get(A);if(S.__webglInit===void 0)return;const O=A.source,re=d.get(O);if(re){const Q=re[S.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&v(A),Object.keys(re).length===0&&d.delete(O)}n.remove(A)}function v(A){const S=n.get(A);s.deleteTexture(S.__webglTexture);const O=A.source,re=d.get(O);delete re[S.__cacheKey],a.memory.textures--}function w(A){const S=A.texture,O=n.get(A),re=n.get(S);if(re.__webglTexture!==void 0&&(s.deleteTexture(re.__webglTexture),a.memory.textures--),A.depthTexture&&A.depthTexture.dispose(),A.isWebGLCubeRenderTarget)for(let Q=0;Q<6;Q++){if(Array.isArray(O.__webglFramebuffer[Q]))for(let ie=0;ie<O.__webglFramebuffer[Q].length;ie++)s.deleteFramebuffer(O.__webglFramebuffer[Q][ie]);else s.deleteFramebuffer(O.__webglFramebuffer[Q]);O.__webglDepthbuffer&&s.deleteRenderbuffer(O.__webglDepthbuffer[Q])}else{if(Array.isArray(O.__webglFramebuffer))for(let Q=0;Q<O.__webglFramebuffer.length;Q++)s.deleteFramebuffer(O.__webglFramebuffer[Q]);else s.deleteFramebuffer(O.__webglFramebuffer);if(O.__webglDepthbuffer&&s.deleteRenderbuffer(O.__webglDepthbuffer),O.__webglMultisampledFramebuffer&&s.deleteFramebuffer(O.__webglMultisampledFramebuffer),O.__webglColorRenderbuffer)for(let Q=0;Q<O.__webglColorRenderbuffer.length;Q++)O.__webglColorRenderbuffer[Q]&&s.deleteRenderbuffer(O.__webglColorRenderbuffer[Q]);O.__webglDepthRenderbuffer&&s.deleteRenderbuffer(O.__webglDepthRenderbuffer)}if(A.isWebGLMultipleRenderTargets)for(let Q=0,ie=S.length;Q<ie;Q++){const _e=n.get(S[Q]);_e.__webglTexture&&(s.deleteTexture(_e.__webglTexture),a.memory.textures--),n.remove(S[Q])}n.remove(S),n.remove(A)}let W=0;function Z(){W=0}function I(){const A=W;return A>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+i.maxTextures),W+=1,A}function V(A){const S=[];return S.push(A.wrapS),S.push(A.wrapT),S.push(A.wrapR||0),S.push(A.magFilter),S.push(A.minFilter),S.push(A.anisotropy),S.push(A.internalFormat),S.push(A.format),S.push(A.type),S.push(A.generateMipmaps),S.push(A.premultiplyAlpha),S.push(A.flipY),S.push(A.unpackAlignment),S.push(A.colorSpace),S.join()}function U(A,S){const O=n.get(A);if(A.isVideoTexture&&qe(A),A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){const re=A.image;if(re===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(re.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{K(O,A,S);return}}t.bindTexture(s.TEXTURE_2D,O.__webglTexture,s.TEXTURE0+S)}function Y(A,S){const O=n.get(A);if(A.version>0&&O.__version!==A.version){K(O,A,S);return}t.bindTexture(s.TEXTURE_2D_ARRAY,O.__webglTexture,s.TEXTURE0+S)}function X(A,S){const O=n.get(A);if(A.version>0&&O.__version!==A.version){K(O,A,S);return}t.bindTexture(s.TEXTURE_3D,O.__webglTexture,s.TEXTURE0+S)}function q(A,S){const O=n.get(A);if(A.version>0&&O.__version!==A.version){fe(O,A,S);return}t.bindTexture(s.TEXTURE_CUBE_MAP,O.__webglTexture,s.TEXTURE0+S)}const $={[Ci]:s.REPEAT,[Vt]:s.CLAMP_TO_EDGE,[Vs]:s.MIRRORED_REPEAT},ne={[gt]:s.NEAREST,[Qr]:s.NEAREST_MIPMAP_NEAREST,[vi]:s.NEAREST_MIPMAP_LINEAR,[wt]:s.LINEAR,[Bs]:s.LINEAR_MIPMAP_NEAREST,[fn]:s.LINEAR_MIPMAP_LINEAR},ce={[zu]:s.NEVER,[Xu]:s.ALWAYS,[Hu]:s.LESS,[ol]:s.LEQUAL,[Gu]:s.EQUAL,[Wu]:s.GEQUAL,[Vu]:s.GREATER,[ku]:s.NOTEQUAL};function Te(A,S,O){if(S.type===Jt&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===wt||S.magFilter===Bs||S.magFilter===vi||S.magFilter===fn||S.minFilter===wt||S.minFilter===Bs||S.minFilter===vi||S.minFilter===fn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),O?(s.texParameteri(A,s.TEXTURE_WRAP_S,$[S.wrapS]),s.texParameteri(A,s.TEXTURE_WRAP_T,$[S.wrapT]),(A===s.TEXTURE_3D||A===s.TEXTURE_2D_ARRAY)&&s.texParameteri(A,s.TEXTURE_WRAP_R,$[S.wrapR]),s.texParameteri(A,s.TEXTURE_MAG_FILTER,ne[S.magFilter]),s.texParameteri(A,s.TEXTURE_MIN_FILTER,ne[S.minFilter])):(s.texParameteri(A,s.TEXTURE_WRAP_S,s.CLAMP_TO_EDGE),s.texParameteri(A,s.TEXTURE_WRAP_T,s.CLAMP_TO_EDGE),(A===s.TEXTURE_3D||A===s.TEXTURE_2D_ARRAY)&&s.texParameteri(A,s.TEXTURE_WRAP_R,s.CLAMP_TO_EDGE),(S.wrapS!==Vt||S.wrapT!==Vt)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),s.texParameteri(A,s.TEXTURE_MAG_FILTER,b(S.magFilter)),s.texParameteri(A,s.TEXTURE_MIN_FILTER,b(S.minFilter)),S.minFilter!==gt&&S.minFilter!==wt&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),S.compareFunction&&(s.texParameteri(A,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(A,s.TEXTURE_COMPARE_FUNC,ce[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const re=e.get("EXT_texture_filter_anisotropic");if(S.magFilter===gt||S.minFilter!==vi&&S.minFilter!==fn||S.type===Jt&&e.has("OES_texture_float_linear")===!1||o===!1&&S.type===es&&e.has("OES_texture_half_float_linear")===!1)return;(S.anisotropy>1||n.get(S).__currentAnisotropy)&&(s.texParameterf(A,re.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,i.getMaxAnisotropy())),n.get(S).__currentAnisotropy=S.anisotropy)}}function k(A,S){let O=!1;A.__webglInit===void 0&&(A.__webglInit=!0,S.addEventListener("dispose",E));const re=S.source;let Q=d.get(re);Q===void 0&&(Q={},d.set(re,Q));const ie=V(S);if(ie!==A.__cacheKey){Q[ie]===void 0&&(Q[ie]={texture:s.createTexture(),usedTimes:0},a.memory.textures++,O=!0),Q[ie].usedTimes++;const _e=Q[A.__cacheKey];_e!==void 0&&(Q[A.__cacheKey].usedTimes--,_e.usedTimes===0&&v(S)),A.__cacheKey=ie,A.__webglTexture=Q[ie].texture}return O}function K(A,S,O){let re=s.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(re=s.TEXTURE_2D_ARRAY),S.isData3DTexture&&(re=s.TEXTURE_3D);const Q=k(A,S),ie=S.source;t.bindTexture(re,A.__webglTexture,s.TEXTURE0+O);const _e=n.get(ie);if(ie.version!==_e.__version||Q===!0){t.activeTexture(s.TEXTURE0+O);const ue=Ze.getPrimaries(Ze.workingColorSpace),me=S.colorSpace===Wt?null:Ze.getPrimaries(S.colorSpace),Ae=S.colorSpace===Wt||ue===me?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,S.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,S.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ae);const Ne=p(S)&&f(S.image)===!1;let ee=_(S.image,Ne,!1,i.maxTextureSize);ee=Pe(S,ee);const $e=f(ee)||o,He=r.convert(S.format,S.colorSpace);let Ie=r.convert(S.type),Se=y(S.internalFormat,He,Ie,S.colorSpace,S.isVideoTexture);Te(re,S,$e);let de;const Oe=S.mipmaps,L=o&&S.isVideoTexture!==!0&&Se!==sl,ae=_e.__version===void 0||Q===!0,he=ie.dataReady,Ee=C(S,ee,$e);if(S.isDepthTexture)Se=s.DEPTH_COMPONENT,o?S.type===Jt?Se=s.DEPTH_COMPONENT32F:S.type===wn?Se=s.DEPTH_COMPONENT24:S.type===qn?Se=s.DEPTH24_STENCIL8:Se=s.DEPTH_COMPONENT16:S.type===Jt&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),S.format===Yn&&Se===s.DEPTH_COMPONENT&&S.type!==fa&&S.type!==wn&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),S.type=wn,Ie=r.convert(S.type)),S.format===Li&&Se===s.DEPTH_COMPONENT&&(Se=s.DEPTH_STENCIL,S.type!==qn&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),S.type=qn,Ie=r.convert(S.type))),ae&&(L?t.texStorage2D(s.TEXTURE_2D,1,Se,ee.width,ee.height):t.texImage2D(s.TEXTURE_2D,0,Se,ee.width,ee.height,0,He,Ie,null));else if(S.isDataTexture)if(Oe.length>0&&$e){L&&ae&&t.texStorage2D(s.TEXTURE_2D,Ee,Se,Oe[0].width,Oe[0].height);for(let R=0,se=Oe.length;R<se;R++)de=Oe[R],L?he&&t.texSubImage2D(s.TEXTURE_2D,R,0,0,de.width,de.height,He,Ie,de.data):t.texImage2D(s.TEXTURE_2D,R,Se,de.width,de.height,0,He,Ie,de.data);S.generateMipmaps=!1}else L?(ae&&t.texStorage2D(s.TEXTURE_2D,Ee,Se,ee.width,ee.height),he&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,ee.width,ee.height,He,Ie,ee.data)):t.texImage2D(s.TEXTURE_2D,0,Se,ee.width,ee.height,0,He,Ie,ee.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){L&&ae&&t.texStorage3D(s.TEXTURE_2D_ARRAY,Ee,Se,Oe[0].width,Oe[0].height,ee.depth);for(let R=0,se=Oe.length;R<se;R++)de=Oe[R],S.format!==kt?He!==null?L?he&&t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,R,0,0,0,de.width,de.height,ee.depth,He,de.data,0,0):t.compressedTexImage3D(s.TEXTURE_2D_ARRAY,R,Se,de.width,de.height,ee.depth,0,de.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?he&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,R,0,0,0,de.width,de.height,ee.depth,He,Ie,de.data):t.texImage3D(s.TEXTURE_2D_ARRAY,R,Se,de.width,de.height,ee.depth,0,He,Ie,de.data)}else{L&&ae&&t.texStorage2D(s.TEXTURE_2D,Ee,Se,Oe[0].width,Oe[0].height);for(let R=0,se=Oe.length;R<se;R++)de=Oe[R],S.format!==kt?He!==null?L?he&&t.compressedTexSubImage2D(s.TEXTURE_2D,R,0,0,de.width,de.height,He,de.data):t.compressedTexImage2D(s.TEXTURE_2D,R,Se,de.width,de.height,0,de.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?he&&t.texSubImage2D(s.TEXTURE_2D,R,0,0,de.width,de.height,He,Ie,de.data):t.texImage2D(s.TEXTURE_2D,R,Se,de.width,de.height,0,He,Ie,de.data)}else if(S.isDataArrayTexture)L?(ae&&t.texStorage3D(s.TEXTURE_2D_ARRAY,Ee,Se,ee.width,ee.height,ee.depth),he&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,ee.width,ee.height,ee.depth,He,Ie,ee.data)):t.texImage3D(s.TEXTURE_2D_ARRAY,0,Se,ee.width,ee.height,ee.depth,0,He,Ie,ee.data);else if(S.isData3DTexture)L?(ae&&t.texStorage3D(s.TEXTURE_3D,Ee,Se,ee.width,ee.height,ee.depth),he&&t.texSubImage3D(s.TEXTURE_3D,0,0,0,0,ee.width,ee.height,ee.depth,He,Ie,ee.data)):t.texImage3D(s.TEXTURE_3D,0,Se,ee.width,ee.height,ee.depth,0,He,Ie,ee.data);else if(S.isFramebufferTexture){if(ae)if(L)t.texStorage2D(s.TEXTURE_2D,Ee,Se,ee.width,ee.height);else{let R=ee.width,se=ee.height;for(let te=0;te<Ee;te++)t.texImage2D(s.TEXTURE_2D,te,Se,R,se,0,He,Ie,null),R>>=1,se>>=1}}else if(Oe.length>0&&$e){L&&ae&&t.texStorage2D(s.TEXTURE_2D,Ee,Se,Oe[0].width,Oe[0].height);for(let R=0,se=Oe.length;R<se;R++)de=Oe[R],L?he&&t.texSubImage2D(s.TEXTURE_2D,R,0,0,He,Ie,de):t.texImage2D(s.TEXTURE_2D,R,Se,He,Ie,de);S.generateMipmaps=!1}else L?(ae&&t.texStorage2D(s.TEXTURE_2D,Ee,Se,ee.width,ee.height),he&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,He,Ie,ee)):t.texImage2D(s.TEXTURE_2D,0,Se,He,Ie,ee);M(S,$e)&&x(re),_e.__version=ie.version,S.onUpdate&&S.onUpdate(S)}A.__version=S.version}function fe(A,S,O){if(S.image.length!==6)return;const re=k(A,S),Q=S.source;t.bindTexture(s.TEXTURE_CUBE_MAP,A.__webglTexture,s.TEXTURE0+O);const ie=n.get(Q);if(Q.version!==ie.__version||re===!0){t.activeTexture(s.TEXTURE0+O);const _e=Ze.getPrimaries(Ze.workingColorSpace),ue=S.colorSpace===Wt?null:Ze.getPrimaries(S.colorSpace),me=S.colorSpace===Wt||_e===ue?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,S.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,S.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,me);const Ae=S.isCompressedTexture||S.image[0].isCompressedTexture,Ne=S.image[0]&&S.image[0].isDataTexture,ee=[];for(let R=0;R<6;R++)!Ae&&!Ne?ee[R]=_(S.image[R],!1,!0,i.maxCubemapSize):ee[R]=Ne?S.image[R].image:S.image[R],ee[R]=Pe(S,ee[R]);const $e=ee[0],He=f($e)||o,Ie=r.convert(S.format,S.colorSpace),Se=r.convert(S.type),de=y(S.internalFormat,Ie,Se,S.colorSpace),Oe=o&&S.isVideoTexture!==!0,L=ie.__version===void 0||re===!0,ae=Q.dataReady;let he=C(S,$e,He);Te(s.TEXTURE_CUBE_MAP,S,He);let Ee;if(Ae){Oe&&L&&t.texStorage2D(s.TEXTURE_CUBE_MAP,he,de,$e.width,$e.height);for(let R=0;R<6;R++){Ee=ee[R].mipmaps;for(let se=0;se<Ee.length;se++){const te=Ee[se];S.format!==kt?Ie!==null?Oe?ae&&t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+R,se,0,0,te.width,te.height,Ie,te.data):t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+R,se,de,te.width,te.height,0,te.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Oe?ae&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+R,se,0,0,te.width,te.height,Ie,Se,te.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+R,se,de,te.width,te.height,0,Ie,Se,te.data)}}}else{Ee=S.mipmaps,Oe&&L&&(Ee.length>0&&he++,t.texStorage2D(s.TEXTURE_CUBE_MAP,he,de,ee[0].width,ee[0].height));for(let R=0;R<6;R++)if(Ne){Oe?ae&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+R,0,0,0,ee[R].width,ee[R].height,Ie,Se,ee[R].data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+R,0,de,ee[R].width,ee[R].height,0,Ie,Se,ee[R].data);for(let se=0;se<Ee.length;se++){const xe=Ee[se].image[R].image;Oe?ae&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+R,se+1,0,0,xe.width,xe.height,Ie,Se,xe.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+R,se+1,de,xe.width,xe.height,0,Ie,Se,xe.data)}}else{Oe?ae&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+R,0,0,0,Ie,Se,ee[R]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+R,0,de,Ie,Se,ee[R]);for(let se=0;se<Ee.length;se++){const te=Ee[se];Oe?ae&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+R,se+1,0,0,Ie,Se,te.image[R]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+R,se+1,de,Ie,Se,te.image[R])}}}M(S,He)&&x(s.TEXTURE_CUBE_MAP),ie.__version=Q.version,S.onUpdate&&S.onUpdate(S)}A.__version=S.version}function ve(A,S,O,re,Q,ie){const _e=r.convert(O.format,O.colorSpace),ue=r.convert(O.type),me=y(O.internalFormat,_e,ue,O.colorSpace);if(!n.get(S).__hasExternalTextures){const Ne=Math.max(1,S.width>>ie),ee=Math.max(1,S.height>>ie);Q===s.TEXTURE_3D||Q===s.TEXTURE_2D_ARRAY?t.texImage3D(Q,ie,me,Ne,ee,S.depth,0,_e,ue,null):t.texImage2D(Q,ie,me,Ne,ee,0,_e,ue,null)}t.bindFramebuffer(s.FRAMEBUFFER,A),oe(S)?c.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,re,Q,n.get(O).__webglTexture,0,J(S)):(Q===s.TEXTURE_2D||Q>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,re,Q,n.get(O).__webglTexture,ie),t.bindFramebuffer(s.FRAMEBUFFER,null)}function Me(A,S,O){if(s.bindRenderbuffer(s.RENDERBUFFER,A),S.depthBuffer&&!S.stencilBuffer){let re=o===!0?s.DEPTH_COMPONENT24:s.DEPTH_COMPONENT16;if(O||oe(S)){const Q=S.depthTexture;Q&&Q.isDepthTexture&&(Q.type===Jt?re=s.DEPTH_COMPONENT32F:Q.type===wn&&(re=s.DEPTH_COMPONENT24));const ie=J(S);oe(S)?c.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,ie,re,S.width,S.height):s.renderbufferStorageMultisample(s.RENDERBUFFER,ie,re,S.width,S.height)}else s.renderbufferStorage(s.RENDERBUFFER,re,S.width,S.height);s.framebufferRenderbuffer(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.RENDERBUFFER,A)}else if(S.depthBuffer&&S.stencilBuffer){const re=J(S);O&&oe(S)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,re,s.DEPTH24_STENCIL8,S.width,S.height):oe(S)?c.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,re,s.DEPTH24_STENCIL8,S.width,S.height):s.renderbufferStorage(s.RENDERBUFFER,s.DEPTH_STENCIL,S.width,S.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.RENDERBUFFER,A)}else{const re=S.isWebGLMultipleRenderTargets===!0?S.texture:[S.texture];for(let Q=0;Q<re.length;Q++){const ie=re[Q],_e=r.convert(ie.format,ie.colorSpace),ue=r.convert(ie.type),me=y(ie.internalFormat,_e,ue,ie.colorSpace),Ae=J(S);O&&oe(S)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,Ae,me,S.width,S.height):oe(S)?c.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Ae,me,S.width,S.height):s.renderbufferStorage(s.RENDERBUFFER,me,S.width,S.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function ge(A,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(s.FRAMEBUFFER,A),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(S.depthTexture).__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),U(S.depthTexture,0);const re=n.get(S.depthTexture).__webglTexture,Q=J(S);if(S.depthTexture.format===Yn)oe(S)?c.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,re,0,Q):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,re,0);else if(S.depthTexture.format===Li)oe(S)?c.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,re,0,Q):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,re,0);else throw new Error("Unknown depthTexture format")}function ze(A){const S=n.get(A),O=A.isWebGLCubeRenderTarget===!0;if(A.depthTexture&&!S.__autoAllocateDepthBuffer){if(O)throw new Error("target.depthTexture not supported in Cube render targets");ge(S.__webglFramebuffer,A)}else if(O){S.__webglDepthbuffer=[];for(let re=0;re<6;re++)t.bindFramebuffer(s.FRAMEBUFFER,S.__webglFramebuffer[re]),S.__webglDepthbuffer[re]=s.createRenderbuffer(),Me(S.__webglDepthbuffer[re],A,!1)}else t.bindFramebuffer(s.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer=s.createRenderbuffer(),Me(S.__webglDepthbuffer,A,!1);t.bindFramebuffer(s.FRAMEBUFFER,null)}function Le(A,S,O){const re=n.get(A);S!==void 0&&ve(re.__webglFramebuffer,A,A.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),O!==void 0&&ze(A)}function D(A){const S=A.texture,O=n.get(A),re=n.get(S);A.addEventListener("dispose",B),A.isWebGLMultipleRenderTargets!==!0&&(re.__webglTexture===void 0&&(re.__webglTexture=s.createTexture()),re.__version=S.version,a.memory.textures++);const Q=A.isWebGLCubeRenderTarget===!0,ie=A.isWebGLMultipleRenderTargets===!0,_e=f(A)||o;if(Q){O.__webglFramebuffer=[];for(let ue=0;ue<6;ue++)if(o&&S.mipmaps&&S.mipmaps.length>0){O.__webglFramebuffer[ue]=[];for(let me=0;me<S.mipmaps.length;me++)O.__webglFramebuffer[ue][me]=s.createFramebuffer()}else O.__webglFramebuffer[ue]=s.createFramebuffer()}else{if(o&&S.mipmaps&&S.mipmaps.length>0){O.__webglFramebuffer=[];for(let ue=0;ue<S.mipmaps.length;ue++)O.__webglFramebuffer[ue]=s.createFramebuffer()}else O.__webglFramebuffer=s.createFramebuffer();if(ie)if(i.drawBuffers){const ue=A.texture;for(let me=0,Ae=ue.length;me<Ae;me++){const Ne=n.get(ue[me]);Ne.__webglTexture===void 0&&(Ne.__webglTexture=s.createTexture(),a.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(o&&A.samples>0&&oe(A)===!1){const ue=ie?S:[S];O.__webglMultisampledFramebuffer=s.createFramebuffer(),O.__webglColorRenderbuffer=[],t.bindFramebuffer(s.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let me=0;me<ue.length;me++){const Ae=ue[me];O.__webglColorRenderbuffer[me]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,O.__webglColorRenderbuffer[me]);const Ne=r.convert(Ae.format,Ae.colorSpace),ee=r.convert(Ae.type),$e=y(Ae.internalFormat,Ne,ee,Ae.colorSpace,A.isXRRenderTarget===!0),He=J(A);s.renderbufferStorageMultisample(s.RENDERBUFFER,He,$e,A.width,A.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+me,s.RENDERBUFFER,O.__webglColorRenderbuffer[me])}s.bindRenderbuffer(s.RENDERBUFFER,null),A.depthBuffer&&(O.__webglDepthRenderbuffer=s.createRenderbuffer(),Me(O.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(s.FRAMEBUFFER,null)}}if(Q){t.bindTexture(s.TEXTURE_CUBE_MAP,re.__webglTexture),Te(s.TEXTURE_CUBE_MAP,S,_e);for(let ue=0;ue<6;ue++)if(o&&S.mipmaps&&S.mipmaps.length>0)for(let me=0;me<S.mipmaps.length;me++)ve(O.__webglFramebuffer[ue][me],A,S,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ue,me);else ve(O.__webglFramebuffer[ue],A,S,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0);M(S,_e)&&x(s.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ie){const ue=A.texture;for(let me=0,Ae=ue.length;me<Ae;me++){const Ne=ue[me],ee=n.get(Ne);t.bindTexture(s.TEXTURE_2D,ee.__webglTexture),Te(s.TEXTURE_2D,Ne,_e),ve(O.__webglFramebuffer,A,Ne,s.COLOR_ATTACHMENT0+me,s.TEXTURE_2D,0),M(Ne,_e)&&x(s.TEXTURE_2D)}t.unbindTexture()}else{let ue=s.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(o?ue=A.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(ue,re.__webglTexture),Te(ue,S,_e),o&&S.mipmaps&&S.mipmaps.length>0)for(let me=0;me<S.mipmaps.length;me++)ve(O.__webglFramebuffer[me],A,S,s.COLOR_ATTACHMENT0,ue,me);else ve(O.__webglFramebuffer,A,S,s.COLOR_ATTACHMENT0,ue,0);M(S,_e)&&x(ue),t.unbindTexture()}A.depthBuffer&&ze(A)}function ot(A){const S=f(A)||o,O=A.isWebGLMultipleRenderTargets===!0?A.texture:[A.texture];for(let re=0,Q=O.length;re<Q;re++){const ie=O[re];if(M(ie,S)){const _e=A.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:s.TEXTURE_2D,ue=n.get(ie).__webglTexture;t.bindTexture(_e,ue),x(_e),t.unbindTexture()}}}function H(A){if(o&&A.samples>0&&oe(A)===!1){const S=A.isWebGLMultipleRenderTargets?A.texture:[A.texture],O=A.width,re=A.height;let Q=s.COLOR_BUFFER_BIT;const ie=[],_e=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ue=n.get(A),me=A.isWebGLMultipleRenderTargets===!0;if(me)for(let Ae=0;Ae<S.length;Ae++)t.bindFramebuffer(s.FRAMEBUFFER,ue.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ae,s.RENDERBUFFER,null),t.bindFramebuffer(s.FRAMEBUFFER,ue.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ae,s.TEXTURE_2D,null,0);t.bindFramebuffer(s.READ_FRAMEBUFFER,ue.__webglMultisampledFramebuffer),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,ue.__webglFramebuffer);for(let Ae=0;Ae<S.length;Ae++){ie.push(s.COLOR_ATTACHMENT0+Ae),A.depthBuffer&&ie.push(_e);const Ne=ue.__ignoreDepthValues!==void 0?ue.__ignoreDepthValues:!1;if(Ne===!1&&(A.depthBuffer&&(Q|=s.DEPTH_BUFFER_BIT),A.stencilBuffer&&(Q|=s.STENCIL_BUFFER_BIT)),me&&s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,ue.__webglColorRenderbuffer[Ae]),Ne===!0&&(s.invalidateFramebuffer(s.READ_FRAMEBUFFER,[_e]),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[_e])),me){const ee=n.get(S[Ae]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,ee,0)}s.blitFramebuffer(0,0,O,re,0,0,O,re,Q,s.NEAREST),l&&s.invalidateFramebuffer(s.READ_FRAMEBUFFER,ie)}if(t.bindFramebuffer(s.READ_FRAMEBUFFER,null),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),me)for(let Ae=0;Ae<S.length;Ae++){t.bindFramebuffer(s.FRAMEBUFFER,ue.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ae,s.RENDERBUFFER,ue.__webglColorRenderbuffer[Ae]);const Ne=n.get(S[Ae]).__webglTexture;t.bindFramebuffer(s.FRAMEBUFFER,ue.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ae,s.TEXTURE_2D,Ne,0)}t.bindFramebuffer(s.DRAW_FRAMEBUFFER,ue.__webglMultisampledFramebuffer)}}function J(A){return Math.min(i.maxSamples,A.samples)}function oe(A){const S=n.get(A);return o&&A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function qe(A){const S=a.render.frame;u.get(A)!==S&&(u.set(A,S),A.update())}function Pe(A,S){const O=A.colorSpace,re=A.format,Q=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||A.format===na||O!==Mt&&O!==Wt&&(Ze.getTransfer(O)===it?o===!1?e.has("EXT_sRGB")===!0&&re===kt?(A.format=na,A.minFilter=wt,A.generateMipmaps=!1):S=ul.sRGBToLinear(S):(re!==kt||Q!==Dn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",O)),S}this.allocateTextureUnit=I,this.resetTextureUnits=Z,this.setTexture2D=U,this.setTexture2DArray=Y,this.setTexture3D=X,this.setTextureCube=q,this.rebindTextures=Le,this.setupRenderTarget=D,this.updateRenderTargetMipmap=ot,this.updateMultisampleRenderTarget=H,this.setupDepthRenderbuffer=ze,this.setupFrameBufferTexture=ve,this.useMultisampledRTT=oe}function ag(s,e,t){const n=t.isWebGL2;function i(r,a=Wt){let o;const c=Ze.getTransfer(a);if(r===Dn)return s.UNSIGNED_BYTE;if(r===Qc)return s.UNSIGNED_SHORT_4_4_4_4;if(r===el)return s.UNSIGNED_SHORT_5_5_5_1;if(r===Au)return s.BYTE;if(r===wu)return s.SHORT;if(r===fa)return s.UNSIGNED_SHORT;if(r===Jc)return s.INT;if(r===wn)return s.UNSIGNED_INT;if(r===Jt)return s.FLOAT;if(r===es)return n?s.HALF_FLOAT:(o=e.get("OES_texture_half_float"),o!==null?o.HALF_FLOAT_OES:null);if(r===Ru)return s.ALPHA;if(r===kt)return s.RGBA;if(r===Cu)return s.LUMINANCE;if(r===Lu)return s.LUMINANCE_ALPHA;if(r===Yn)return s.DEPTH_COMPONENT;if(r===Li)return s.DEPTH_STENCIL;if(r===na)return o=e.get("EXT_sRGB"),o!==null?o.SRGB_ALPHA_EXT:null;if(r===Pu)return s.RED;if(r===tl)return s.RED_INTEGER;if(r===Iu)return s.RG;if(r===nl)return s.RG_INTEGER;if(r===il)return s.RGBA_INTEGER;if(r===cr||r===lr||r===ur||r===hr)if(c===it)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(r===cr)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===lr)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===ur)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===hr)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(r===cr)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===lr)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===ur)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===hr)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===Ga||r===Va||r===ka||r===Wa)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(r===Ga)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===Va)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===ka)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===Wa)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===sl)return o=e.get("WEBGL_compressed_texture_etc1"),o!==null?o.COMPRESSED_RGB_ETC1_WEBGL:null;if(r===Xa||r===ja)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(r===Xa)return c===it?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(r===ja)return c===it?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===qa||r===Ya||r===Ka||r===$a||r===Za||r===Ja||r===Qa||r===eo||r===to||r===no||r===io||r===so||r===ro||r===ao)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(r===qa)return c===it?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===Ya)return c===it?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===Ka)return c===it?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===$a)return c===it?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===Za)return c===it?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===Ja)return c===it?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===Qa)return c===it?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===eo)return c===it?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===to)return c===it?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===no)return c===it?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===io)return c===it?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===so)return c===it?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===ro)return c===it?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===ao)return c===it?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===dr||r===oo||r===co)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(r===dr)return c===it?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===oo)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===co)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===Du||r===lo||r===uo||r===ho)if(o=e.get("EXT_texture_compression_rgtc"),o!==null){if(r===dr)return o.COMPRESSED_RED_RGTC1_EXT;if(r===lo)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===uo)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===ho)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===qn?n?s.UNSIGNED_INT_24_8:(o=e.get("WEBGL_depth_texture"),o!==null?o.UNSIGNED_INT_24_8_WEBGL:null):s[r]!==void 0?s[r]:null}return{convert:i}}class og extends Pt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Cn extends at{constructor(){super(),this.isGroup=!0,this.type="Group"}}const cg={type:"move"};class Or{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Cn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Cn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new P,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new P),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Cn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new P,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new P),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let i=null,r=null,a=null;const o=this._targetRay,c=this._grip,l=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(l&&e.hand){a=!0;for(const _ of e.hand.values()){const f=t.getJointPose(_,n),p=this._getHandJoint(l,_);f!==null&&(p.matrix.fromArray(f.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=f.radius),p.visible=f!==null}const u=l.joints["index-finger-tip"],h=l.joints["thumb-tip"],d=u.position.distanceTo(h.position),m=.02,g=.005;l.inputState.pinching&&d>m+g?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!l.inputState.pinching&&d<=m-g&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else c!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(c.matrix.fromArray(r.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,r.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(r.linearVelocity)):c.hasLinearVelocity=!1,r.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(r.angularVelocity)):c.hasAngularVelocity=!1));o!==null&&(i=t.getPose(e.targetRaySpace,n),i===null&&r!==null&&(i=r),i!==null&&(o.matrix.fromArray(i.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,i.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(i.linearVelocity)):o.hasLinearVelocity=!1,i.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(i.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(cg)))}return o!==null&&(o.visible=i!==null),c!==null&&(c.visible=r!==null),l!==null&&(l.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Cn;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const lg=`
void main() {
